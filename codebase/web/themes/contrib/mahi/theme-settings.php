...
function mahi_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h4>Thanks for using Mahi Theme</h4><p>Mahi is a free Drupal 9 & 10 theme designed and developed by <a href="https://drupar.com" target="_blank">Drupar.com</a></p>'),
    '#group' => 'mahi',
  ];
  // layout tab.
  $form['layout'] = [
